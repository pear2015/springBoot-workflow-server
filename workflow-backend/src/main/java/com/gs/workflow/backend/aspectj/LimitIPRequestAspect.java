...
import com.gs.workflow.common.exception.HttpRestException;
...
public class LimitIPRequestAspect {
     ...
     */
    @Before("execution(* com.gs.workflow.webapi.controller.*.*(..)) && @annotation(com.gs.workflow.common.annotation.LimitIPRequestAnnotation)")
