package com.gs.workflow.backend.aspectj;
...
public class ControllerLogAspectJ {
     ...
     */
    @Before("execution(public * com.gs.workflow.webapi.controller..*.*(..))")
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(public * com.gs.workflow.webapi.controller..*.*(..))")
     ...
     */
    @AfterThrowing(pointcut = "execution(public * com.gs.workflow.webapi.controller..*.*(..))", throwing = "throwable")
